        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.black, paddingTop: Platform.OS === 'android' ? hp(2.5) : 0 }} >
            <View style={style.container}>
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <Spacer />
                    <TouchableOpacity onPress={() => props?.navigation.navigate(Routes.referrals)} style={{ flexDirection: "row", alignItems: "center" }}>
                    ...
                    <Spacer />
                    <TouchableOpacity style={{ flexDirection: "row", alignItems: "center" }} onPress={() => props?.navigation?.navigate?.(Routes.addressBook)}>
                    ...
                    <Line height={hp(0.1)} width={wp(90)} />
                    <Spacer />
                    <TouchableOpacity style={{ flexDirection: "row", alignItems: "center" }} onPress={() => props?.navigation?.navigate?.(Routes.settingProfile)}>
                    ...
                    <Spacer />
                    <TouchableOpacity style={{ flexDirection: "row", alignItems: "center" }} onPress={() => props?.navigation?.navigate?.(Routes.settingSecurity)}>
                    ...
                    <Spacer />
                    <TouchableOpacity style={{ flexDirection: "row", alignItems: "center" }} onPress={() => props?.navigation?.navigate?.(Routes.settingEmailNotification)} >
                    ...
                    <Spacer />
                    <TouchableOpacity style={{ flexDirection: "row", alignItems: "center" }} onPress={() => props?.navigation?.navigate?.(Routes.settingSystem)} >
                    ...
                    <Line height={hp(0.1)} width={wp(90)} />
                    <Spacer />
                    <TouchableOpacity style={appStyles.rowBasic} onPress={() => props?.navigation?.navigate(Routes.ContactSupport)}>
